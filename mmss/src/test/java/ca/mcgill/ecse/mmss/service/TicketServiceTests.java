...
public class TicketServiceTests {
    ...
    public void testRetrieveTicketById () { 
        ...
        when(ticketRepository.findTicketByBookingId(any(int.class))).thenAnswer((InvocationOnMock invocation) -> ticket); 
    ...
    public void testCreateTicketInvalidUsername () { 
        ...
        MmssException ex = assertThrows(MmssException.class, () -> ticketService.createTicket("badUsername", Date.valueOf("2022-11-16")));
    ...
    public void testCreateTicketInvalidOpenDay () { 
        ...
        MmssException ex = assertThrows(MmssException.class, () -> ticketService.createTicket("jon.snow@got.com", invalidDate));
    ...
    public void testUpdateTicket() {
        ...
        when(openDayRepository.findOpenDayByDate(any(Date.class))).thenAnswer((InvocationOnMock invocation) -> updatedOpenDay);
        when(ticketRepository.save(any(Ticket.class))).thenAnswer((InvocationOnMock invocation) -> invocation.getArgument(0)); 
        when(ticketRepository.findTicketByBookingId(any(int.class))).thenAnswer((InvocationOnMock invocation) -> oldTicket); 
