...
public class TicketService {
    ...
    /**
     * Creates a ticket. Checks if museum open on the day. Checks if 0 tickets are booked.
     * @param username
     * @param date
    ...
    public Ticket createTicket (String username, Date date, int numberOfTickets) {
    	...
    	if (visitor == null) {          
    		 throw new MmssException(HttpStatus.NOT_FOUND, "Name can't be empty.");
    	}
    ...
    public void deleteTicket(int id) {
    	Ticket ticket = ticketRepository.findTicketByBookingId(id);
    	if (ticket == null) throw new MmssException(HttpStatus.NOT_FOUND, "The ticket with this Id was not found.");
    	ticketRepository.delete(ticket);
    }

    /**
     * Takes id and date of a ticket to modify booking date
     * @param id
     * @param date
     * @return ticket
     * @author Shyam Desai
