<template>
    <!-- A form will popup to update visitors-->
    <div id="UpdateVisitorForm">
...
export default {
    ...
    created: function () {
        this.request.userName = JSON.parse(sessionStorage.getItem('loggedInVisitor')).userName
    },
